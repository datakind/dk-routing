...
def main(user_directory='data'):
    OUTPUT_DATA_DIR = f'/opt/WORKING_DATA_DIR/{user_directory}/output_data/'
    INPUT_DATA_DIR = f'/opt/WORKING_DATA_DIR/{user_directory}/input_data/' # should test cloud setting eventually
