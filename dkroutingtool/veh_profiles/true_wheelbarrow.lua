-- Wheelbarrow - Foot-inspired profile
...
function setup()
  local walking_speed = 2.93 --average wheelbarrow speed, in km/h 
  return {
    properties = {
      weight_name                   = 'duration',
      max_speed_for_map_matching    = 9.1/3.6, -- max wheelbarrow speed, in m/s (only speed with m/s in this file)
