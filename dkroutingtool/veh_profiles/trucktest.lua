...
function setup()
  ...
  return {
    ...
    vehicle_height = 2.75, -- in meters, 2.5m is the height of van
    vehicle_width = 2.5, -- in meters, ways with narrow tag are considered narrower than 2.2m

    -- Size of the vehicle, to be limited mostly by legal restriction of the way
    vehicle_length = 7, -- in meters, 4.8m is the length of large or familly car
    vehicle_weight = 6800, -- in kilograms
